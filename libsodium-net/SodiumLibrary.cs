...
namespace Sodium
{
	static class SodiumLibrary
	{
		...
		public  static extern int crypto_aead_aes256gcm_encrypt (IntPtr c, out long clen_p, byte[] m, long mlen, byte[] ad, long adlen, byte[] nsec, byte[] npub, byte[] k);
		...
		public  static extern  int crypto_aead_aes256gcm_decrypt (IntPtr m,out long mlen_p, byte[] nsec, byte[] c, long clen, byte[] ad, long adlen, byte[] npub, byte[] k);
		...
		public  static extern  int crypto_aead_aes256gcm_encrypt_detached (byte[] c, byte[] mac, long maclen_p, byte[] m, long mlen, byte[] ad, long adlen, byte[] nsec, byte[] npub, byte[] k);
		...
		public  static extern  int crypto_aead_aes256gcm_decrypt_detached (byte[] m, byte[] nsec, byte[] c, long clen, byte[] mac, byte[] ad, long adlen, byte[] npub, byte[] k);
		...
		public  static extern  int crypto_aead_aes256gcm_encrypt_afternm (byte[] c, long  clen_p, byte[] m, long mlen, byte[] ad, long adlen, byte[] nsec, byte[] npub, byte[][] ctx_);
		...
		public  static extern  int crypto_aead_aes256gcm_decrypt_afternm (byte[] m, long  mlen_p, byte[] nsec, byte[] c, long clen, byte[] ad, long adlen, byte[] npub, byte[][] ctx_);
		...
		public  static extern  int crypto_aead_aes256gcm_encrypt_detached_afternm (byte[] c, byte[] mac, long  maclen_p, byte[] m, long mlen, byte[] ad, long adlen, byte[] nsec, byte[] npub, byte[][] ctx_);
		...
		public  static extern  int crypto_aead_aes256gcm_decrypt_detached_afternm (byte[] m, byte[] nsec, byte[] c, long clen, byte[] mac, byte[] ad, long adlen, byte[] npub, byte[][] ctx_);
		...
		public  static extern  int crypto_aead_chacha20poly1305_ietf_encrypt (byte[] c, long  clen_p, byte[] m, long mlen, byte[] ad, long adlen, byte[] nsec, byte[] npub, byte[] k);
		...
		public  static extern  int crypto_aead_chacha20poly1305_ietf_decrypt (byte[] m, long  mlen_p, byte[] nsec, byte[] c, long clen, byte[] ad, long adlen, byte[] npub, byte[] k);
		...
		public  static extern  int crypto_aead_chacha20poly1305_ietf_encrypt_detached (byte[] c, byte[] mac, long  maclen_p, byte[] m, long mlen, byte[] ad, long adlen, byte[] nsec, byte[] npub, byte[] k);
		...
		public  static extern  int crypto_aead_chacha20poly1305_ietf_decrypt_detached (byte[] m, byte[] nsec, byte[] c, long clen, byte[] mac, byte[] ad, long adlen, byte[] npub, byte[] k);
		...
		public  static extern  int crypto_aead_chacha20poly1305_encrypt (IntPtr c,out long  clen_p, byte[] m, long mlen, byte[] ad, long adlen, byte[] nsec, byte[] npub, byte[] k);

		// extern int crypto_aead_chacha20poly1305_decrypt (unsigned char *m, unsigned long long *mlen_p, unsigned char *nsec, const unsigned char *c, unsigned long long clen, const unsigned char *ad, unsigned long long adlen, const unsigned char *npub, const unsigned char *k) __attribute__((visibility("default"))) __attribute__((warn_unused_result));
		[DllImport ("__Internal")]
	
		public  static extern  int crypto_aead_chacha20poly1305_decrypt (IntPtr m, out long  mlen_p, byte[] nsec, byte[] c, long clen, byte[] ad, long adlen, byte[] npub, byte[] k);
		...
		public  static extern  int crypto_aead_chacha20poly1305_encrypt_detached (byte[] c, byte[] mac,ref long  maclen_p, byte[] m, long mlen, byte[] ad, long adlen, byte[] nsec, byte[] npub, byte[] k);
		...
		public  static extern  int crypto_aead_chacha20poly1305_decrypt_detached (byte[] m, byte[] nsec, byte[] c, long clen, byte[] mac, byte[] ad, long adlen, byte[] npub, byte[] k);
		...
		public  static extern  int crypto_hash_sha512 (byte[] @out, byte[] @in, long inlen);
		...
		public  static extern  int crypto_hash_sha512_update (IntPtr state, byte[] @in, long inlen);
		...
		public  static extern  int crypto_auth_hmacsha512 (byte[] @out, byte[] @in, long inlen, byte[] k);
		...
		public  static extern  int crypto_auth_hmacsha512_verify (byte[] h, byte[] @in, long inlen, byte[] k);
		...
		public  static extern  int crypto_auth_hmacsha512_update (IntPtr state, byte[] @in, long inlen);
		...
		public  static extern  int crypto_auth_hmacsha512256 (byte[] @out, byte[] @in, long inlen, byte[] k);
		...
		public  static extern  int crypto_auth_hmacsha512256_verify (byte[] h, byte[] @in, long inlen, byte[] k);
		...
		public  static extern  int crypto_auth_hmacsha512256_update (IntPtr state, byte[] @in, long inlen);
		...
		public  static extern  byte[] crypto_auth_primitive ();
		...
		public  static extern  int crypto_auth (byte[] @out, byte[] @in, long inlen, byte[] k);
		...
		public  static extern  int crypto_auth_verify (byte[] h, byte[] @in, long inlen, byte[] k);
		...
		public  static extern  int crypto_hash_sha256 (byte[] @out, byte[] @in, long inlen);
		...
		public  static extern  int crypto_hash_sha256_update (IntPtr state, byte[] @in, long inlen);
		...
		public  static extern  int crypto_auth_hmacsha256 (byte[] @out, byte[] @in, long inlen, byte[] k);
		...
		public  static extern  int crypto_auth_hmacsha256_verify (byte[] h, byte[] @in, long inlen, byte[] k);
		...
		public  static extern  int crypto_auth_hmacsha256_update (IntPtr state, byte[] @in, long inlen);
		...
		public  static extern  int crypto_box_curve25519xsalsa20poly1305 (byte[] c, byte[] m, long mlen, byte[] n, byte[] pk, byte[] sk);
		...
		public  static extern  int crypto_box_curve25519xsalsa20poly1305_open (byte[] m, byte[] c, long clen, byte[] n, byte[] pk, byte[] sk);
		...
		public  static extern  int crypto_box_curve25519xsalsa20poly1305_afternm (byte[] c, byte[] m, long mlen, byte[] n, byte[] k);
		...
		public  static extern  int crypto_box_curve25519xsalsa20poly1305_open_afternm (byte[] m, byte[] c, long clen, byte[] n, byte[] k);
		...
		public  static extern  byte[] crypto_box_primitive ();
		...
		public  static extern  int crypto_box_easy (byte[] c, byte[] m, long mlen, byte[] n, byte[] pk, byte[] sk);
		...
		public  static extern  int crypto_box_open_easy (byte[] m, byte[] c, long clen, byte[] n, byte[] pk, byte[] sk);
		...
		public  static extern  int crypto_box_detached (byte[] c, byte[] mac, byte[] m, long mlen, byte[] n, byte[] pk, byte[] sk);
		...
		public  static extern  int crypto_box_open_detached (byte[] m, byte[] c, byte[] mac, long clen, byte[] n, byte[] pk, byte[] sk);
		...
		public  static extern  int crypto_box_easy_afternm (byte[] c, byte[] m, long mlen, byte[] n, byte[] k);
		...
		public  static extern  int crypto_box_open_easy_afternm (byte[] m, byte[] c, long clen, byte[] n, byte[] k);
		...
		public  static extern  int crypto_box_detached_afternm (byte[] c, byte[] mac, byte[] m, long mlen, byte[] n, byte[] k);
		...
		public  static extern  int crypto_box_open_detached_afternm (byte[] m, byte[] c, byte[] mac, long clen, byte[] n, byte[] k);
		...
		public  static extern  int crypto_box_seal (byte[] c, byte[] m, long mlen, byte[] pk);
		...
		public  static extern  int crypto_box_seal_open (byte[] m, byte[] c, long clen, byte[] pk, byte[] sk);
		...
		public  static extern  int crypto_box (byte[] c, byte[] m, long mlen, byte[] n, byte[] pk, byte[] sk);
		...
		public  static extern  int crypto_box_open (byte[] m, byte[] c, long clen, byte[] n, byte[] pk, byte[] sk);
		...
		public  static extern  int crypto_box_afternm (byte[] c, byte[] m, long mlen, byte[] n, byte[] k);
		...
		public  static extern  int crypto_box_open_afternm (byte[] m, byte[] c, long clen, byte[] n, byte[] k);
		...
		public  static extern  int crypto_generichash_blake2b (byte[] @out, long outlen, byte[] @in, long inlen, byte[] key, long keylen);
		...
		public  static extern  int crypto_generichash_blake2b_salt_personal (byte[] @out, long outlen, byte[] @in, long inlen, byte[] key, long keylen, byte[] salt, byte[] personal);
		...
		public  static extern  int crypto_generichash_blake2b_update (IntPtr state, byte[] @in, long inlen);
		...
		public  static extern  byte[] crypto_generichash_primitive ();
		...
		public  static extern  int crypto_generichash (byte[] @out, long outlen, byte[] @in, long inlen, byte[] key, long keylen);
		...
		public  static extern  int crypto_generichash_update (IntPtr state, byte[] @in, long inlen);
		...
		public  static extern  int crypto_hash (byte[] @out, byte[] @in, long inlen);

		// extern const char * crypto_hash_primitive () __attribute__((visibility("default"))) __attribute__((warn_unused_result));
		[DllImport ("__Internal")]
	
		public  static extern  byte[] crypto_hash_primitive ();
		...
		public  static extern  int crypto_onetimeauth_poly1305 (byte[] @out, byte[] @in, long inlen, byte[] k);
		...
		public  static extern  int crypto_onetimeauth_poly1305_verify (byte[] h, byte[] @in, long inlen, byte[] k);
		...
		public  static extern  int crypto_onetimeauth_poly1305_update (IntPtr state, byte[] @in, long inlen);
		...
		public  static extern  byte[] crypto_onetimeauth_primitive ();
		...
		public  static extern  int crypto_onetimeauth (byte[] @out, byte[] @in, long inlen, byte[] k);
		...
		public  static extern  int crypto_onetimeauth_verify (byte[] h, byte[] @in, long inlen, byte[] k);
		...
		public  static extern  int crypto_onetimeauth_update (IntPtr state, byte[] @in, long inlen);
		...
		public  static extern  byte[] crypto_pwhash_argon2i_strprefix ();
		...
		public  static extern  int crypto_pwhash_argon2i (byte[] @out, long outlen, byte[] passwd, long passwdlen, byte[] salt, long opslimit, long memlimit, int alg);
		...
		public  static extern  int crypto_pwhash_argon2i_str (byte[] @out, byte[] passwd, long passwdlen, long opslimit, long memlimit);
		...
		public  static extern  int crypto_pwhash_argon2i_str_verify (byte[] str, byte[] passwd, long passwdlen);
		...
		public  static extern  byte[] crypto_pwhash_strprefix ();
		...
		public  static extern  int crypto_pwhash (byte[] @out, long outlen, byte[] passwd, long passwdlen, byte[] salt, long opslimit, long memlimit, int alg);
		...
		public  static extern  int crypto_pwhash_str (byte[] @out, byte[] passwd, long passwdlen, long opslimit, long memlimit);
		...
		public  static extern  int crypto_pwhash_str_verify (byte[] str, byte[] passwd, long passwdlen);

		// extern const char * crypto_pwhash_primitive () __attribute__((visibility("default"))) __attribute__((warn_unused_result));
		[DllImport ("__Internal")]
	
		public  static extern  byte[] crypto_pwhash_primitive ();
		...
		public  static extern  byte[] crypto_pwhash_scryptsalsa208sha256_strprefix ();
		...
		public  static extern  int crypto_pwhash_scryptsalsa208sha256 (byte[] @out, long outlen, byte[] passwd, long passwdlen, byte[] salt, long opslimit, long memlimit);
		...
		public  static extern  int crypto_pwhash_scryptsalsa208sha256_str (byte[] @out, byte[] passwd, long passwdlen, long opslimit, long memlimit);
		...
		public  static extern  int crypto_pwhash_scryptsalsa208sha256_str_verify (byte[] str, byte[] passwd, long passwdlen);
		...
		public  static extern  int crypto_pwhash_scryptsalsa208sha256_ll (byte[] passwd, long passwdlen, byte[] salt, long saltlen, long N, uint r, uint p, byte[] buf, long buflen);
		...
		public  static extern  int crypto_secretbox_xsalsa20poly1305 (byte[] c, byte[] m, long mlen, byte[] n, byte[] k);
		...
		public  static extern  int crypto_secretbox_xsalsa20poly1305_open (byte[] m, byte[] c, long clen, byte[] n, byte[] k);
		...
		public  static extern  byte[] crypto_secretbox_primitive ();
		...
		public  static extern  int crypto_shorthash_siphash24 (byte[] @out, byte[] @in, long inlen, byte[] k);
		...
		public  static extern  byte[] crypto_shorthash_primitive ();
		...
		public  static extern  int crypto_shorthash (byte[] @out, byte[] @in, long inlen, byte[] k);
		...
		public  static extern  int crypto_sign_ed25519 (byte[] sm, long  smlen_p, byte[] m, long mlen, byte[] sk);
		...
		public  static extern  int crypto_sign_ed25519_open (byte[] m, long  mlen_p, byte[] sm, long smlen, byte[] pk);
		...
		public  static extern  int crypto_sign_ed25519_detached (byte[] sig, long  siglen_p, byte[] m, long mlen, byte[] sk);
		...
		public  static extern  int crypto_sign_ed25519_verify_detached (byte[] sig, byte[] m, long mlen, byte[] pk);
		...
		public  static extern  byte[] crypto_sign_primitive ();
		...
		public  static extern  int crypto_sign (byte[] sm, ref long  smlen_p, byte[] m, long mlen, byte[] sk);
		...
		public  static extern  int crypto_sign_open (byte[] m,ref long  mlen_p, byte[] sm, long smlen, byte[] pk);
		...
		public  static extern  int crypto_sign_detached (byte[] sig, ref long  siglen_p, byte[] m, long mlen, byte[] sk);
		...
		public  static extern  int crypto_sign_verify_detached (byte[] sig, byte[] m, long mlen, byte[] pk);
		...
		public  static extern  int crypto_stream_xsalsa20 (byte[] c, long clen, byte[] n, byte[] k);
		...
		public  static extern  int crypto_stream_xsalsa20_xor (byte[] c, byte[] m, long mlen, byte[] n, byte[] k);
		...
		public  static extern  int crypto_stream_xsalsa20_xor_ic (byte[] c, byte[] m, long mlen, byte[] n, long ic, byte[] k);
		...
		public  static extern  byte[] crypto_stream_primitive ();
		...
		public  static extern  int crypto_stream (byte[] c, long clen, byte[] n, byte[] k);
		...
		public  static extern  int crypto_stream_xor (byte[] c, byte[] m, long mlen, byte[] n, byte[] k);
		...
		public  static extern  int crypto_stream_aes128ctr (byte[] @out, long outlen, byte[] n, byte[] k);
		...
		public  static extern  int crypto_stream_aes128ctr_xor (byte[] @out, byte[] @in, long inlen, byte[] n, byte[] k);
		...
		public  static extern  int crypto_stream_aes128ctr_afternm (byte[] @out, long len, byte[] nonce, byte[] c);
		...
		public  static extern  int crypto_stream_aes128ctr_xor_afternm (byte[] @out, byte[] @in, long len, byte[] nonce, byte[] c);
		...
		public  static extern  int crypto_stream_chacha20 (byte[] c, long clen, byte[] n, byte[] k);
		...
		public  static extern  int crypto_stream_chacha20_xor (byte[] c, byte[] m, long mlen, byte[] n, byte[] k);
		...
		public  static extern  int crypto_stream_chacha20_xor_ic (byte[] c, byte[] m, long mlen, byte[] n, long ic, byte[] k);
		...
		public  static extern  int crypto_stream_chacha20_ietf (byte[] c, long clen, byte[] n, byte[] k);
		...
		public  static extern  int crypto_stream_chacha20_ietf_xor (byte[] c, byte[] m, long mlen, byte[] n, byte[] k);
		...
		public  static extern  int crypto_stream_chacha20_ietf_xor_ic (byte[] c, byte[] m, long mlen, byte[] n, uint ic, byte[] k);
		...
		public  static extern  int crypto_stream_salsa20 (byte[] c, long clen, byte[] n, byte[] k);
		...
		public  static extern  int crypto_stream_salsa20_xor (byte[] c, byte[] m, long mlen, byte[] n, byte[] k);
		...
		public  static extern  int crypto_stream_salsa20_xor_ic (byte[] c, byte[] m, long mlen, byte[] n, long ic, byte[] k);
		...
		public  static extern  int crypto_stream_salsa2012 (byte[] c, long clen, byte[] n, byte[] k);
		...
		public  static extern  int crypto_stream_salsa2012_xor (byte[] c, byte[] m, long mlen, byte[] n, byte[] k);
		...
		public  static extern  int crypto_stream_salsa208 (byte[] c, long clen, byte[] n, byte[] k);
		...
		public  static extern  int crypto_stream_salsa208_xor (byte[] c, byte[] m, long mlen, byte[] n, byte[] k);
		...
		public  static extern int randombytes_uniform (int upper_bound);
		...
		public  static extern  byte[] randombytes_implementation_name ();

		// extern void randombytes (unsigned char *const buf, const unsigned long long buf_len) __attribute__((visibility("default")));
		[DllImport ("__Internal")]
	
		public  static extern  void randombytes (byte[] buf, long buf_len);
		...
		public  static extern  IntPtr sodium_bin2hex (byte[] hex, long hex_maxlen, byte[] bin, long bin_len);
		...
		public  static extern  int sodium_hex2bin (IntPtr bin, long bin_maxlen, string hex, long hex_len, string ignore, out int bin_len, byte[] hex_end);
